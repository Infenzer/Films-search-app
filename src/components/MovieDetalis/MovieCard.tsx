      ...
      <div className="container-lg movie-card-body">
        <div className="poster-wrapper">
          ...
          <div className="raitings">
            {info.Ratings[2] !== undefined && (
              <ul>
                <li><img className="metacritic" src='/img/Metacritic.jpg' alt=""/> {info.Ratings[2].Value} </li>
                <li><img className="rotten-tomatoes" src='/img/RottenTomatoes.jpg' alt=""/> {info.Ratings[1].Value}  </li>
              </ul>
            )}
          </div>
        </div>
